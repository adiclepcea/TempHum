...
****************************************************************************/
void TWI_Start_Transceiver_With_Data( char *msg, unsigned char msgSize )
{
	uint8_t temp;
...
****************************************************************************/
unsigned char TWI_Get_Data_From_Transceiver( char *msg, uint8_t msgSize )
{
	uint8_t i;
	while ( TWI_Transceiver_Busy() ) {} // Wait until TWI is ready for next transmission.
